...
public class Trip {
	...
	private DateTimeFormatter displayTimeFormatter = DateTimeFormatter.ofPattern("HH:mm");
	...
	public String getDepartureTime() {
		return departureTime.format(displayTimeFormatter);
	}
	public void setDepartureTime(String departureTime) {
		this.departureTime = LocalTime.parse(departureTime, timeFormatter);
	}
	public String getArrivalTime() {
		return arrivalTime.format(displayTimeFormatter);
	}
